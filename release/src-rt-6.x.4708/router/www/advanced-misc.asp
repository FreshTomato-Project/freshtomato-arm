...
/* BCMARM-END */
		...
		createFieldTable('', [
			...
			null,
<div class="note-spacer"><small>* Autonegotiate is 1000Mbps or highest speed network or hardware or cable allows. Speed issues use port health check.</small></div>
