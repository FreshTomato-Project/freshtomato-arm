...
//	<% nvram("t_model_name,os_version,lan_ipaddr,lan_netmask,dhcpd_static,cstats_include,dhcpd_slt"); %>
...
<div class="section">
	...
	<input type="button" value="Restore" id="restore-button" onclick="restore()">
